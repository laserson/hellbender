...
public final class IndelUtils {
    ...
    public static List<Integer> findEventClassificationIndex(VariantContext vc, ReferenceContext ref) {
        int eventLength;
    ...
    public static String getIndelClassificationName(int k) {
        if (k >=0 && k < COLUMN_KEYS.length)
            ...
            throw new GATKException("Invalid index when trying to get indel classification name");
    }
