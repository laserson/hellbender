...
public class ArtificialSAMUtils {
    ...
    public static GATKRead createArtificialRead(SAMFileHeader header, String name, int refIndex, int alignmentStart, int length) {
        ...
        GATKRead record = new SAMRecordToGATKReadAdapter(new SAMRecord(header));
        record.setName(name);
        record.setPosition(header.getSequence(refIndex).getSequenceName(), alignmentStart);
    ...
    public static GATKRead createArtificialRead(SAMFileHeader header, String name, int refIndex, int alignmentStart, byte[] bases, byte[] qual) {
        ...
        GATKRead rec = createArtificialRead(header, name, refIndex, alignmentStart, bases.length);
    ...
    public static GATKRead createArtificialRead(SAMFileHeader header, String name, int refIndex, int alignmentStart, byte[] bases, byte[] qual, String cigar) {
        GATKRead rec = createArtificialRead(header, name, refIndex, alignmentStart, bases, qual);
        rec.setCigar(cigar);
        return rec;
    }
    ...
    public static GATKRead createArtificialRead(byte[] bases, byte[] qual, String cigar) {
        ...
        return ArtificialSAMUtils.createArtificialRead(header, bases, qual, cigar);
    }

    public static GATKRead createArtificialRead(final SAMFileHeader header, byte[] bases, byte[] qual, String cigar) {
