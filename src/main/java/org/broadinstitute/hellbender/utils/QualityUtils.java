 ...
 * quality scores.
 *
 * The definition of a Phred-scaled quality Q in terms of an error probability e is:
 * Q = -10 log_10 e, which implies log e = Q * (-log(10)/10)
 */
public final class QualityUtils {
     ...
     */
    public static double PHRED_TO_LOG_PROB_MULTIPLIER = -Math.log(10)/10.0;
    public static double LOG_PROB_TO_PHRED_MULTIPLIER = 1/PHRED_TO_LOG_PROB_MULTIPLIER;
    ...
    public static byte trueProbToQual(final double trueProb, final byte maxQual) {
        ...
        final double lp = Math.round(LOG_PROB_TO_PHRED_MULTIPLIER * MathUtils.logOneMinusX(trueProb));
    ...
    public static double phredScaleLogErrorRate(final double logErrorRate) {
        ...
        return Math.abs(LOG_PROB_TO_PHRED_MULTIPLIER * Math.max(logErrorRate, RAW_MIN_PHRED_SCALED_QUAL));
    }
