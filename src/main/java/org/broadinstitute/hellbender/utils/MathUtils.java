...
public final class MathUtils {
    ...
    private static final class JacobianLogTable {
        ...
        // with base-10 log, this was set to 8.0.  The equivalent for natural log is 8.0 * log(10)
        // this comment should be deleted after code review
        public static final double MAX_TOLERANCE = 18.42068;
        ...
        private static void initialize() {
            if (cache == null) {
                final int tableSize = (int) (MAX_TOLERANCE / TABLE_STEP) + 2;
        ...
        //This is 1/1000 times the difference between log-probabilities for consecutive phred-scaled qualities.
        // having an exact divisor means that the "approximate" sum effectively caches exact values
        // for integer phred scores
        private static final double TABLE_STEP = 0.00023025850929;
